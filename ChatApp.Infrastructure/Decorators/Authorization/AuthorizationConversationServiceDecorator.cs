...
{
    public class AuthorizationConversationServiceDecorator(IConversationService conversationService, IAuthService authService, ICurrentUserService currentUserService, IAuthorizationHandler<Conversation> authorizationHandler) : AuthorizationDecoratorBase<Conversation, ConversationResponseDto>(conversationService, authService, currentUserService, authorizationHandler), IConversationService
    {
