...
{
    public class AuthorizationMessageHandler : IAuthorizationHandler<Message>
    {
        public Task<bool> AuthorizeAsync(Message resource, Permission permission, Guid? requestUserGuid = null)
        {
