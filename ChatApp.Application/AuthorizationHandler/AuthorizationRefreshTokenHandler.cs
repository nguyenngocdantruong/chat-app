...
{
    public class AuthorizationRefreshTokenHandler : IAuthorizationHandler<RefreshToken>
    {
        public Task<bool> AuthorizeAsync(RefreshToken resource, Permission permission, Guid? requestUserGuid = null)
        {
