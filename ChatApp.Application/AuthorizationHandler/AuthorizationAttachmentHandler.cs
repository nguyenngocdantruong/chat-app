...
{
    public class AuthorizationAttachmentHandler : IAuthorizationHandler<Attachment>
    {
        public Task<bool> AuthorizeAsync(Attachment resource, Permission permission, Guid? requestUserGuid = null)
        {
