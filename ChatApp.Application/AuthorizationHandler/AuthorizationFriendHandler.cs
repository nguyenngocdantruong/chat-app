...
{
    public class AuthorizationFriendHandler : IAuthorizationHandler<Friend>
    {
        public Task<bool> AuthorizeAsync(Friend resource, Permission permission, Guid? requestUserGuid = null)
        {
