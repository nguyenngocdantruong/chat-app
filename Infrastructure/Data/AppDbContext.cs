...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ConversationEvent>(entity =>
        {
            ...
            entity.HasOne(d => d.Conversation).WithMany(p => p.ConversationEvents).HasConstraintName("FK__Conversat__Conve__5AEE82B9");
        });
        ...
        modelBuilder.Entity<ConversationMember>(entity =>
        {
            ...
            entity.Property(e => e.Role).HasDefaultValue("Member").HasConversion<string>();
        ...
        modelBuilder.Entity<Message>(entity =>
        {
            ...
            entity.Property(e => e.MessageType).HasConversion<string>().HasMaxLength(50);
        ...
        modelBuilder.Entity<MessageStatus>(entity =>
        {
            ...
            entity.Property(e => e.Reaction).HasConversion<string>().HasMaxLength(5).HasDefaultValue("None");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK__OtpReque__3214EC07E0089FF1");
        ...
        modelBuilder.Entity<FcmToken>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.FcmTokens).HasConstraintName("FK__UserFcmToken__693CA210");
        });
